									...
									<c:forEach var="bDTO" items="${list}">
										<tbody class="listBody">
											...
											<tr>
												<!-- num -->
												<td scope="row">
													<div id="num">${bDTO.bNum}</div>
												</td>
												<!-- category -->
												<td><c:set var="category" value="category" /> <c:choose>
												...
												<!-- subject -->
												<td>
													<!-- 부모 페이지의 창 변환 --> <a href="#none"
													onclick="javascript:window.parent.location.href='select.do?bNum=${bDTO.bNum}'"><b>${bDTO.title}</b></a>
												</td>
												<!-- writer -->
												<td>${bDTO.writer}</td>
												<!-- views -->
												...
												<!-- deleteBtn -->
												<td>
													<form id="f${bDTO.bNum}" action="delete_myboard.do" method="post">
					...
					<div class="card-footer py-4">
						...
						<ul class="pagination justify-content-center">
							<li class="page-item disabled"><a class="page-link" href="#"
								tabindex="-1"> <i class="fa fa-angle-left"></i> <span
