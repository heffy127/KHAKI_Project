   	...
   	$(function(){
   		...
   		$("#cpBtn").click(function(){
   			...
   			$.ajax({
	 			...
	 			success:function(data){
	 				swal("쿠폰 등록에 성공했습니다.");
	 				location.href="admin_coupon2.do";
	 			},
	 			error : function(xhr, status) {
	 				swal(xhr + " : " + status);
	 			}
      ...
      <div style="width: 50%; float: left; border-right: 8px solid #f5f5f5; padding: 1%;">
         <div id="cpPage" style="width:100%; text-align:right; margin-bottom: 10px; position: relative;">
            ...
            <div id="cpFrame" style="width: 100%;">
               ...
               <div id="realCp1" style="word-wrap:break-word; position: absolute; top: 42%; left: 32%; width: 255px; color: white; font-size: 23px; font-weight: bold; text-align: center;"><label id="realCpp1"></label><label>시간 이상 이용시</label></div>
      ...
      <div id="cpInsert" style="text-align:center; width: 50%; float: left; padding: 1%;">
         <div>
            <div>
               ...
               <label>이용조건 시간</label>&nbsp;&nbsp;&nbsp;<input type="text" id="cTitle1" name="cTitle1" placeholder="이용조건 시간을 입력해주세요." style="width: 35%;"><br><br>
               ...
               <button type="button" class="btn btn-outline-default" style="width: 30%; font-size: 15px; margin: 0 5% 0 5%;" onclick="location.href='admin_coupon1.do'">~이상 결제시</button>
		      	<button type="button" class="btn btn-outline-default" style="width: 30%; font-size: 15px; margin: 0 5% 0 5%;" onclick="location.href='admin_coupon3.do'">~시에 예약시</button>
         </div>
      </div>
