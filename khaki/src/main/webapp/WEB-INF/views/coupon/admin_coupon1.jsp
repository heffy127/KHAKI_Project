      ...
      <div style="width: 50%; float: left; border-right: 8px solid #f5f5f5; padding: 1%;">
         <div id="cpPage" style="width:100%; text-align:right; margin-bottom: 10px; position: relative;">
            ...
            <div id="cpFrame" style="width: 100%;">
               ...
               <div id="realCp1" style="word-wrap:break-word; position: absolute; top: 42%; left: 32%; width: 255px; color: white; font-size: 23px; font-weight: bold; text-align: center;"><label id="realCpp1"></label><label>원 이상 결제시</label></div>
      ...
      <div id="cpInsert" style="text-align:center; width: 50%; float: left; padding: 1%;">
         <div>
            <div>
               ...
               <label>이용조건 금액</label>&nbsp;&nbsp;&nbsp;<input type="text" id="cTitle1" name="cTitle1" placeholder="이용조건 금액을 입력해주세요." style="width: 35%;"><br><br>
