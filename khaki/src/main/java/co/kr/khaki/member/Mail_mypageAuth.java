...
public class Mail_mypageAuth {
	public void mailSender(MemberDTO memberDTO, String authNum) {
		...
		String subject = "[KHAKI] 회원정보 수정 인증메일 발송"; // 메일 제목 입력해주세요.

		String body = "KHAKI에서 회원정보 수정 이메일 인증을 위한 인증메일을 보내드립니다.\n아래의 링크를 눌러 인증을 진행해주세요.\n\n http://localhost:9999/khaki/mypage_emailAuth_ok.do?emailAuthNum="+ authNum + "&id=" + memberDTO.getId() +"\n\n\n* 본 메일은 KHAKI에서 발송한 메일이며 발신전용 메일입니다. *"; // 메일 내용 입력해주세요.
